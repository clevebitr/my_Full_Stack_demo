...
function moreicon(){
    ...
    if (item.style.marginLeft == "0px") {
        ...
        document.getElementById('more_icon_exit').style.display="none";
        document.getElementById('more_icon').style.display="flex";
    } else {
        item.style.marginLeft = "0px";
        document.getElementById('more_icon_exit').style.display="flex";
        document.getElementById('more_icon').style.display="none";
    }
}
function moreiconexit(){
    var item = document.getElementById('sidebar')
    if (item.style.marginLeft == "0px") {
        item.style.marginLeft ="-100px";
        document.getElementById('more_icon_exit').style.display="none";
